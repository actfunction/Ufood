...
public class UrlBase64
{
	...
	public static byte[] encode(byte data[])
	{
		...
		{
			throw new RuntimeException((new StringBuilder()).append("exception encoding URL safe base64 string: ").append(e).toString());
		}
	...
	public static byte[] decode(byte data[])
	{
		...
		{
			throw new RuntimeException((new StringBuilder()).append("exception decoding URL safe base64 string: ").append(e).toString());
		}
		return bOut.toByteArray();
	}

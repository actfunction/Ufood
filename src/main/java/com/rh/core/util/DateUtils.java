...
public class DateUtils extends Object {
	...
	/** 时间格式. */
	public static final String FORMAT_DATE_CODE = "yyyyMMdd";
	/** 时间格式. */
	...
	public static void main(String[] args) {
		String str1 = "2018-08-01 00:00:00";
		String str3 = "2018-08-02 00:00:00";
		String str2 = "2018-08-31 23:59:59";
		String str4 = "2018-08-31 00:00:00";


		System.out.println(DateUtils.getDateAdded(2, str1));
		
		System.out.println(DateUtils.getDiffTime(str4, str4));
	 ...
	 * 获取当前时间yyMMdd格式日期字符串
	 * 
	 * @return yyMMdd格式日期字符串
	 */
	public static String getDateCode() {
		Calendar calendar = Calendar.getInstance();
		return getStringFromDate(calendar.getTime(), FORMAT_DATE_CODE);
	}
}

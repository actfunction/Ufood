 ...
 * 司内办理中的事项
 */
public class BureauQueryHandling extends CommonServ {
    ...
    public OutBean query(ParamBean paramBean) {
        ...
        sql.append(" FROM SUP_APPRO_BUREAU t1 WHERE (t1.APPLY_STATE = '5' OR " +
                ...
                "DEPT_TYPE = '1') AND APPRO_ID = t1.ID AND ROWNUM = 1 ORDER BY S_ATIME DESC) = '3' AND t1.APPLY_STATE = '4')) ");
        //拼接用户所选查询条件

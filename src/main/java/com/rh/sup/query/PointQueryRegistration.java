 ...
 * 要点类的立项登记
 */
public class PointQueryRegistration extends CommonServ {
    ...
    public OutBean query(ParamBean paramBean) {
        ...
        //增加程序所定义的其他字段
        sql.append(select+" ,APPR_DATE AS S_MTIME , NOT_LIMIT_TIME_REASON ");
        //设定查询表名，并添加查询条件，添加一定的权限
        sql.append(" FROM SUP_APPRO_POINT t1 WHERE  (APPLY_STATE = '1' OR APPLY_STATE = '2' OR APPLY_STATE = '3') ");
        //拼接用户所选查询条件

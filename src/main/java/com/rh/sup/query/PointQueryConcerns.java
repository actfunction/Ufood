 ...
 * 要点类的关注事项
 */
public class PointQueryConcerns extends CommonServ {
    ...
    public OutBean query(ParamBean paramBean) {
        ...
        //设定查询表名，并添加查询条件，添加一定的权限
        sql.append(" FROM SUP_APPRO_POINT t1 WHERE APPLY_STATE = '5' AND " +
                "'SUP_DC_001' NOT IN\n" +
        ...
        //拼接查询权限的限制
        sql.append(ProcessingUnitData.getQueryShiro("Point"));
        //拼接导出数据所需的特定查询条件
